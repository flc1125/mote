/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/access-oauth-probe/wrangler.api.jsonc --strict-vars=false --env-interface=ProbeEnv apps/access-oauth-probe/worker-configuration.d.ts` (hash: 05595d81672af148b73cb24ae6570108)
// Runtime types generated with workerd@1.20260831.1 2026-08-15 nodejs_compat
interface __BaseEnv_ProbeEnv {
  DOCUMENTS: R2Bucket;
...
declare namespace Cloudflare {
  ...
  interface Env extends __BaseEnv_ProbeEnv {}
}
interface ProbeEnv extends __BaseEnv_ProbeEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
  [Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'VIEWER_BASE_URL' | 'ACCESS_ISSUER' | 'ACCESS_AUD'>
  > {}
}
