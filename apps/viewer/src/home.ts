...
<pre tabindex="0" role="region" aria-label="Static-token quick start commands"><code>npm install -g mote-cli

export MOTE_API_URL="https://mote.example.com"
export MOTE_TOKEN="your-token"

mote README.md</code></pre>
<p>For your own static-token instance. Using Cloudflare Access? See the <a href="${DOCS}/authentication.md">authentication guide</a>.</p>
</section>
</main>
