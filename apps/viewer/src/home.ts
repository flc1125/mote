...
.home-footer { max-width: var(--home-max); margin: 0 auto; padding: 30px 24px 44px; border-top: 1px solid var(--mote-border); display: flex; flex-wrap: wrap; gap: 8px 20px; justify-content: space-between; font-size: 14px; color: var(--mote-muted); }
